#!/bin/bash
# =============================================================================
# EC2 User Data Script - PRODUCTION Environment
# =============================================================================
...
#
# This is the PRODUCTION version - identical to staging except:
#   - ENVIRONMENT=production (so the app knows which env it's running in)
#
...
if docker pull ${docker_image}:${app_version}; then
  ...
  #   -e ENVIRONMENT=production Tell the app it's running in production
